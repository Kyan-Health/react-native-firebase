...
- (NSDictionary *)firebaseUserToDict:(FIRUser *)user {
  return @{
    ...
    keyUid : user.uid,
    @"multiFactor" : [self convertMultiFactorData:user.multiFactor]
  };
}

- (NSDictionary *)convertMultiFactorData:(FIRMultiFactor *)multiFactor {
  return @{@"enrolledFactors" : multiFactor.enrolledFactors};
}
